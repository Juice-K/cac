      ...
      <div className="container relative z-10 px-4 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto animate-fade-in-up animation-delay-200">
            Community Advancement Collective provides free essential services including 
            food assistance, GED education, and veteran support to those who need it most.
          </p>
